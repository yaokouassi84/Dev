                ...
                <div class="row g-4">
                        ...
                        <div class="team-item border-top border-5 border-primary rounded shadow overflow-hidden">
                            <div class="text-center p-4">
                               <img class="img-fluid rounded-circle mb-4" src="img/JavaChapitre.png" alt="">
                                <h5 class="fw-bold mb-1">Front End</h5>
                                <small>Voir les livres</small>
                            </div>                            
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item border-top border-5 border-primary rounded shadow overflow-hidden">
                            <div class="text-center p-4">
                                <img class="img-fluid rounded-circle mb-4" src="img/JavaChapitre.png" alt="">
                                <h5 class="fw-bold mb-1">Base de données</h5>
                                <small>Voir les livres</small>
                            </div>                            
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item border-top border-5 border-primary rounded shadow overflow-hidden">
                            <div class="text-center p-4">
                                <img class="img-fluid rounded-circle mb-4" src="img/JavaChapitre.png" alt="">
                                <h5 class="fw-bold mb-1">Autres</h5>
                                <small>Voir les livres</small>
                            </div>                           
                        </div>
                    </div>
